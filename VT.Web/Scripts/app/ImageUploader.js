...
ImageUploader.prototype.performUpload_old = function(imageData, completionCallback) {
...
ImageUploader.prototype.performUpload = function (imageData, completionCallback) {
    ...
    var key = "workflowimages/" + result.fileName; //file.name
    var params = {
        Key: key,
    ...
    bucket.upload(params, function (err, data) {
        ...
        if (err == null) {
            var img = document.createElement("IMG");
            img.src = "http://verifyteck.s3.amazonaws.com/" + key;
            $(containerId).html(img);
            //setTimeout(function () {
            //    //resizeMe(containerId);
            //}, 2000);
